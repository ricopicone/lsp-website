"""Trim the Tuition Assistance body (copy edits).

Follows 0009. Two small edits requested after review:

- Drop the year-end reconciliation sentence ("At the end of the academic
  year, in June, the administrator confirms that everyone paying tuition has
  paid the full annual amount of {{ annual_tuition }}."). The following
  reminder/escalation sentence stays.
- Drop the word "written" from the student's own record-keeping phrasing.
"""
...
It remains each member's responsibility to keep their own record of tuition payments.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("documents", "0009_reword_tuition_assistance"),
    ]
