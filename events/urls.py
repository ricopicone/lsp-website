...
urlpatterns = [
    ...
    path("<slug:slug>/edit/registration-status/",
         views.event_registration_status, name="registration_status"),
    ...
    path("<slug:slug>/codes/<int:pk>/revoke/", views.event_revoke_code, name="revoke_code"),
